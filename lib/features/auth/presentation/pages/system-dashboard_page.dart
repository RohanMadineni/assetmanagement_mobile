...
class _SystemDashboardPageState extends State<SystemDashboardPage> {
    ...
    Future<void> loadStats() async{
        final result = await assetService.getAllStats();
        // print(result);
        setState(() {
            stats = result.data;
        });
    ...
    Future<void> loadData() async {
      final warranties = await assetService.getAllUpcomingAssets();
      final recent = await assetService.getAllRecentlyAssignedAssets();
